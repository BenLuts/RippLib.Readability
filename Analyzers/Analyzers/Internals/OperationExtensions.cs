...
internal static class OperationExtensions
{
    ...
    public static ITypeSymbol GetActualType(this IOperation operation)
    {
        ...
        {
            return conversionOperation.Operand.GetActualType();
        }
    ...
    public static IOperation UnwrapImplicitConversionOperations(this IOperation operation)
    {
        ...
        {
            return conversionOperation.Operand.UnwrapImplicitConversionOperations();
        }
    ...
    public static bool IsInStaticContext(this IOperation operation, CancellationToken cancellationToken) => operation.IsInStaticContext(cancellationToken, out _);

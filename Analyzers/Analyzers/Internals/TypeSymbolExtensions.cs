...
{
    private static readonly string[] _microsoft_VisualStudio_TestTools_UnitTesting = ["Microsoft", "VisualStudio", "TestTools", "UnitTesting"];
    private static readonly string[] _nUnit_Framework = ["NUnit", "Framework"];
    private static readonly string[] _xunit = ["Xunit"];
    ...
    public static bool IsOrImplements(this ITypeSymbol symbol, ITypeSymbol interfaceType)
    {
        ...
        return symbol.GetAllInterfacesIncludingThis().Any(interfaceType.IsEqualTo);
    }
    ...
    {
        return symbol is not null && symbol.GetEnumerationType() is not null;
    }
    ...
    public static bool IsUnitTestClass(this ITypeSymbol typeSymbol)
    {
        ...
        foreach (var attribute in attributes)
        {
            ...
            while (type is not null)
            {
                ...
                if (ns.IsNamespace(_microsoft_VisualStudio_TestTools_UnitTesting) ||
                    ns.IsNamespace(_nUnit_Framework) ||
                    ns.IsNamespace(_xunit))
                {
                    return true;
                }

...
{
    public override ImmutableArray<string> FixableDiagnosticIds => [RuleIdentifiers.PreferEmptyOverNotAny];
    ...
    public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        if (!Enum.TryParse(diagnostic.Properties.GetValueOrDefault("Data", ""), ignoreCase: false, out PreferEmptyOverNotAnyData data) || data is PreferEmptyOverNotAnyData.None)
            return;
        ...
        switch (data)
        {
            case PreferEmptyOverNotAnyData.EmptyOverNotAny:

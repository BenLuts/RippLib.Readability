...
|-----------|----------|----------|
| C# implementation | Masterchief | New extension methods, bug fixes, refactoring |
| Roslyn analyzers & code fixes | Masterchief | New analyzer rules, diagnostics, code fix providers |
| API design | Masterchief | Public extension method naming, signatures, ergonomics |
| Code review | Masterchief | Review PRs, check quality, enforce readability standards |
| Testing | Masterchief | Write unit/integration tests, find edge cases, verify fixes |
| CI/CD pipelines | Forge | GitHub Actions workflows, build/test/release automation |
| Release automation | Forge | NuGet publishing, versioning, changelog, release workflows |
